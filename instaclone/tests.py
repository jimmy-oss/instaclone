...
class ProfileTestClass(TestCase):
    def setUp(self):
        ...
        self.user.save()
        self.profile=Profile(user=self.user,name='kim',bio='am awesome.',profile_pic='default.png')
    def tearDown(self):
...
class PostTestClass(TestCase):
    def setUp(self):
        ...
        self.user.save()
        self.profile=Profile(user=self.user,name='kim',bio='i am awesome.',profile_pic='default.png')
